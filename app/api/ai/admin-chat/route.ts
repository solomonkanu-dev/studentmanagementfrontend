...
function buildSystemPrompt(): string {
  return `You are an administrative assistant embedded in a school management portal. You help the school administrator quickly understand key metrics about their institution.
