                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <Badge variant={eventVariant(event.type)}>{TYPE_LABELS[event.type]}</Badge>
                        </div>
                        {countdown && (
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-body">School events, exams, and holidays for your child&apos;s school</p>
      </div>
