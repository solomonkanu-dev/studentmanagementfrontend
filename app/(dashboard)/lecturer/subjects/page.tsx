...
import { Search, BookOpen, ClipboardList, Hash, School, X, ChevronRight } from "lucide-react";
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="mt-1 text-xs text-body">Class: {className}</p>
      </CardHeader>
            ...
            {filtered.map((s) => {
              ...
              return (
                <button
                  ...
                  className={[
                    "w-full rounded-sm border text-left shadow-default transition-all",
