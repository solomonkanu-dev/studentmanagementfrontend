...
const adminNav: NavItem[] = [
  ...
  { label: "Theme",         href: "/admin/theme",        icon: Palette,   group: "Administration" },
  {
    ...
    children: [
      ...
      { label: "Report Card",          href: "/admin/settings/report-card" },
      { label: "Rating Traits",        href: "/admin/settings/rating-traits" },
...
const parentNav: NavItem[] = [
  ...
  { label: "Assignments",       href: "/parent/assignments",        icon: ClipboardList,   moduleKey: "assignments" },
