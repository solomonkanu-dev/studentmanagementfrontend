  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hi! I'm your admin assistant. Ask me about your institution's fees, attendance, enrollment, salary, or any other school data.",
    },
  ]);
    ...
    <>
      ...
      <button
        ...
        className={[
          ...
          open ? "bg-meta-1 hover:bg-opacity-90" : "bg-primary hover:bg-opacity-90",
        ].join(" ")}
      >
        {open ? (
      ...
      <div
        className={[
          "fixed bottom-24 right-6 z-50 flex w-[380px] max-w-[calc(100vw-2rem)] flex-col rounded-2xl border border-stroke bg-white shadow-2xl transition-all duration-200 dark:border-strokedark dark:bg-boxdark",
          open
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-stroke px-4 py-3 dark:border-strokedark">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-meta-3">Online · Live data</p>
            </div>
          </div>
          <button
